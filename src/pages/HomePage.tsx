          ...
          >
            <Box textAlign="left">
              ...
              <Typography variant="body1" my={4}>
                Hemos desarrollado la mejor herramienta para que puedas tener un
                control total sobre el avance de tus proyectos con nosotros y lo
                mejor es que es super fácil de usar.
              </Typography>
              <Link
